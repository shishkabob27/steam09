...
namespace DepotDownloader
{
	...
	class CDNClientPool
	{
		...
		{
			Console.WriteLine("CDNClientPool: Creating CDNClientPool");
			this.steamSession = steamSession;
			this.appId = appId;
			CDNClient = new Client(steamSession.steamClient);
			Console.WriteLine("CDNClientPool: CDNClient created");
		}

		public async Task UpdateServerList()
		{
			Console.WriteLine("CDNClientPool: Getting servers for steam pipe");
			...
			{
				Console.WriteLine("CDNClientPool: No servers found");
