...
public class GamePropertiesWindow : SteamWindow
{
	...
	{
		this.game = game;
		SetWindowTitle($"{game.Name} - Properties");

		closeButton = new ButtonControl(panel, renderer, "closebutton", 0, 0, 72, 24, "Close", 1);
		...
		tabList.Children.Add(new TabItem(panel, renderer, "tabitem_general", 0, 0, 98, 22, "General", tabList));
		tabList.Children.Add(new TabItem(panel, renderer, "tabitem_updates", 0, 0, 98, 22, "Updates", tabList));
		tabList.Children.Add(new TabItem(panel, renderer, "tabitem_localfiles", 0, 0, 98, 22, "Local files", tabList));
		tabList.Children.Add(new TabItem(panel, renderer, "tabitem_language", 0, 0, 98, 22, "Language", tabList));
	...
	public override void Draw()
	{
		...
		{
			panel.DrawText("Homepage", 32, 79, new Color(218, 222, 214, 255));
			panel.DrawText(game.GetHomepage(), 156, 79, new Color(255, 255, 255, 255), true, true);

			panel.DrawText("Developer", 32, 109, new Color(218, 222, 214, 255));
			panel.DrawText(game.GetDeveloper(), 156, 109, new Color(255, 255, 255, 255), true, true);

			panel.DrawText("Manual", 32, 137, new Color(218, 222, 214, 255));
